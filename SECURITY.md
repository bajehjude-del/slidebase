...
We actively maintain and patch the following versions of Slidebase:
...
Slidebase handles real user funds and Stellar keypairs. Security vulnerabilities — especially those affecting vault key management, the rule engine, or the Soroban smart contract — must be reported responsibly.
...
If you are running your own instance of Slidebase:
